function System(main) {
    ...
    function prepareRepos() {
        $gridRepo.jqGrid({
            ...
            ondblClickRow: function (rowid) {
                ...
                if (editingRepos.indexOf(rowid) === -1)
                    editingRepos.push(rowid);
            },
    ...
    function prepareCerts() {
        $gridCerts.jqGrid({
            ...
            ondblClickRow: function (rowid) {
                ...
                if (editingCerts.indexOf(rowid) === -1)
                    editingCerts.push(rowid);
            },
            loadComplete: function () {
                initCertButtons();
            },
    ...
    function initRepoButtons() {
        $('.repo-edit-submit').unbind('click').button({
            ...
            if (editingRepos.indexOf('repo_' + id) === -1)
                editingRepos.push(rowid);
        });
